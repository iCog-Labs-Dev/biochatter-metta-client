...
<template>
  <div class="flex flex-col w-full h-full">
    ...
    <div class="flex flex-col gap-y-4 h-full justify-center items-center p-20">
      ...
      <div v-if="multiStep.upload.uploading" class="flex flex-col gap-3 items-center">
        <svg aria-hidden="true" class="w-10 aspect-square text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span class="">Upoading...</span>
    </div>
    
            
        <div v-if="!multiStep.upload.uploading">
          <p class="text-center font-bold text-2xl">
          {{ 
          multiStep.upload.success ?
        ...
        <div>
          <p class="text-center text-color-cool-gray text-lg">
